...
from .build_vocab_unit import build_vocab_unit, build_vocab_unit_from_file
...
class SplitPreprocessor(BasicPreprocessor):
    """
    ...
    def fit(self, data_pack: DataPack, verbose: int = 1):
        ...
        if self.vocab_file != None:
            vocab_unit = build_vocab_unit_from_file(self.vocab_file, verbose=verbose)
        else:
    ...
    def transform(self, data_pack: DataPack, verbose: int = 1) -> DataPack:
        ...
        data_pack.right[KeyWordSettings.TextRightInput] = data_pack.right[KeyWordSettings.TextRightInput].apply(process_decoder_input_output)
        data_pack.right[KeyWordSettings.TextRightOutput] = data_pack.right[KeyWordSettings.TextRightOutput].apply(process_decoder_input_output)
