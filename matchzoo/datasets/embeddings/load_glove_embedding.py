...
def load_default_embedding(term_index: mz.preprocessors.units.Vocabulary.TermIndex = None,
                           dimension: int = 50) -> mz.embedding.Embedding:
    """
    Return the pretrained glove embedding.
    ...
    :return: The :class:`mz.embedding.Embedding` object.
    """
    return mz.embedding.Embedding({}, dimension)
